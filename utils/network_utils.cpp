...
// SL_SEC_MASK_TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256 // does not work (-340, handshake fails)
    ...
    if(lRetVal < 0) {
        return printErrConvenience((char*)"Device couldn't retrieve the host name \n\r", lRetVal);
    }
    ...
    if( iSockID < 0 ) {
        return printErrConvenience((char*)"Device unable to create secure socket \n\r", lRetVal);
    }
    ...
    lRetVal = sl_SetSockOpt(iSockID, SL_SOL_SOCKET, SL_SO_SECMETHOD, &ucMethod,\
                               sizeof(ucMethod));
    if(lRetVal < 0) {
        return printErrConvenience((char*)"Device couldn't set socket options \n\r", lRetVal);
    }
    //
...
/////////////////////////////////
    ...
    if(lRetVal >= 0) {
        ...
        UART_PRINT("%s", g_Host);
        UART_PRINT("\n\r");
        return printErrConvenience((char*)"Device couldn't connect to server \n\r", lRetVal);
    }
